...
CMD ["sh", "-c", "./node_modules/.bin/prisma db push --schema=apps/backend/prisma/schema.prisma --accept-data-loss --config=apps/backend/prisma.config.ts && node dist/apps/backend/main.js"]
